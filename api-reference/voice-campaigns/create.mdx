...
curl -X POST "https://sendazi.com/api/v1/v1/voice-campaigns" \
...
const response = await fetch('https://sendazi.com/api/v1/v1/voice-campaigns', {
  method: 'POST',
  headers: {
...
with open('/path/to/audio.mp3', 'rb') as audio_file:
    response = requests.post(
        'https://sendazi.com/api/v1/v1/voice-campaigns',
        headers={
            'Authorization': 'Bearer YOUR_API_KEY'
        },
        data={
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://sendazi.com/api/v1/v1/voice-campaigns',
